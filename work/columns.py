...
def labels_and_pos(model_wrapper, version, country, for_plot=True):
    ...
    elif ((version == "2") and (country != "FRDEBE") and (country != "FRDE") and (country != "FRBE") and (country != "DEBE")  ):
    ...
    elif ((version == "2") and (country == "FRBE")):
        prfx, lags, feature_labels, feature_names_ordered, i_init = label_and_pos_vFRBE(cc, country, sort_func, order_concat)
    elif ((version == "2") and (country == "DEBE")):
        prfx, lags, feature_labels, feature_names_ordered, i_init = label_and_pos_vDEBE(cc, country, sort_func, order_concat)
...
def label_and_pos_vFRBE(cc, country, sort_func, order_concat):
        prfx = ["FR_energy", "FR_Generation forecast", "FR_price",
                "DE_price", "DE_Ampirion Load Forecast", "DE_PV+Wind Forecast",
                "BE_price", "NL_price", "CH_price", "ES_price"]
        lags = {
            ...
            "FR_price" : [f"_past_{i}" for i in sort_func((7, 3, 2, 1))],
            "BE_price" : [f"_past_{i}" for i in sort_func((7, 3, 2, 1))],
            "DE_price" : [f"_past_{i}" for i in sort_func((7, 1))],
            # TODO mettre le pays manquant seulement (7, 1)
            "NL_price" : [f"_past_{i}" for i in sort_func((7, 1))],
            "CH_price" : order_concat(
                [f"_past_{i}" for i in sort_func((7, 1))], [""]),
...
def label_and_pos_vDEBE(cc, country, sort_func, order_concat):

        prfx = ["FR_energy", "FR_Generation forecast", "FR_price",
                "DE_price", "DE_Ampirion Load Forecast", "DE_PV+Wind Forecast",
                "BE_price", "NL_price", "CH_price"]
        lags = {
            "FR_energy" : order_concat(
                [f"_past_{i}" for i in sort_func((7, 1))], [""]),
            "FR_Generation forecast" : order_concat(
            ...
            "DE_PV+Wind Forecast" : order_concat(
                [f"_past_{i}" for i in sort_func((7, 1))], [""]),
            "FR_price" : [f"_past_{i}" for i in sort_func((7, 1))],
            "BE_price" : [f"_past_{i}" for i in sort_func((7, 3, 2, 1))],
            "DE_price" : [f"_past_{i}" for i in sort_func((7, 3, 2, 1))],
            # TODO mettre le pays manquant seulement (7, 1)
            "NL_price" : [f"_past_{i}" for i in sort_func((7, 1))],
